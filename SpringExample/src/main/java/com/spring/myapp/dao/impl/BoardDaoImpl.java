...
public class BoardDaoImpl implements BoardDao{
	...
	public int regContent(Map<String, Object> paramMap) {
    	System.out.println(paramMap.get("subject").toString());
	System.out.println(paramMap.get("writer").toString());
	System.out.println(paramMap.get("password").toString());
	System.out.println(paramMap.get("content").toString());
